...
Wordy is a training program based on a proven methodologies with the main goal to help people remember information pieces. Wordy based on time-proven methodologies and researches confirmed their effectiveness.

**Push information to the brain fast**. Made for productivity Wordy has minimal interface and uses shorcuts for the most actions. Wordy build on the edge technologies to be fast and secrure.

**How does it work?** Save terms to collections then Wordy guide you through collections to effectively learn and keep information using great methodology invented by memory expert [Hermann Ebbinghaus](https://en.wikipedia.org/wiki/Hermann_Ebbinghaus). This methodology widely used in educational programs around the world.
...
Ebbinghaus’s research dates back to the 1880s, but it in 2015, a research team successfully reproduced his findings and concluded that his methods and theories still held true.
