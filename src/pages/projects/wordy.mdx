...
og_image: ""
og_description: "A program for learning foreign words and terms in an interactive way."
---
...
**Push information to the brain fast**. Made for productivity Wordy has minimal interface and uses shorcuts for the most actions. Wordy build on the edge technologies to be fast and secure.

## How does it work?

Save terms to collections then Wordy guide you through collections to effectively learn and keep information using great methodology invented by memory expert [Hermann Ebbinghaus](https://en.wikipedia.org/wiki/Hermann_Ebbinghaus). This methodology widely used in educational programs around the world.
...
Wordy helps to prevent information overload and remember what is really actual. sMark collections you need to remember on regular basis and Wordy will do his job.
